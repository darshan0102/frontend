  ...
  return (
    <div className=''>
      ...
      <div>
        ...
        <div className='flex flex-col justify-center items-center container space-y-4 mx-auto mt-10'>
        {
            product.map((item ) =>  (
                ...
                <form className="flex-auto p-6">
                  ...
                  <div className="flex space-x-4 mb-6 text-sm font-medium">
                    <div className="flex-auto flex space-x-4">
                      <button className="h-10 px-6 flex justify-center egxt-lg items-center font-semibold rounded-md border border-slate-200 text-slate-900 hover:text-slate-200 hover:bg-blue-900 transition duration-300" type="button" onClick={() => dispatch(add_to_cart(item))}>
