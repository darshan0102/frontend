...
const Form = () => {
  ...
  return (
    <div>
      <h1 className='p-2 bg-red-400 text-white text-center'>User Information Form</h1>
      <form onSubmit={handleSubmit}>
        ...
        <button type="submit" className="mt-4 p-2 bg-red-500 text-white rounded">Submit</button>
      </form>
    </div>
  );
}
